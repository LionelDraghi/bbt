...
procedure Put_Help (Topic : Settings.Help_Topic) is
   Base_Help      : constant String with External_Initialization => "help/base.md";
   Filtering_Help : constant String with External_Initialization => "help/filtering.md";
   Matching_Help  : constant String with External_Initialization => "help/matching.md";
   Other_Help     : constant String with External_Initialization => "help/other.md";
   Debug_Help     : constant String with External_Initialization => "help/debug.md";
   Tutorial_Help  : constant String with External_Initialization => "help/tutorial.md";
   Example_Help   : constant String with External_Initialization => "help/example.md";
...
begin
   case Topic is
      ...
      when Filtering => Put (Filtering_Help);
         --  New_Line;
         --  Put_Line ("Filtering:");
      ...
      when Matching => Put (Matching_Help);
         --  New_Line;
      ...
      when Tutorial =>         Put (Tutorial_Help);

      when Example => Put (Example_Help);
