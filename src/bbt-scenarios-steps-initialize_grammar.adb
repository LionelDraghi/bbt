...
begin
   ...
   Set (Given, No_SA,  Subject_File, Containing, No_Object, (Create_If_None, True, new String'("- Given the file `config.ini` containing followed by code fenced content")));   -- Given the file `config.ini` containing followed by code fenced content
                                                                                       -- Fixme : we currently do not check if the existing file contains
                                                                                       --  what is expected
   Set (Given, New_SA, Subject_File, No_Verb,    No_Object, (Erase_And_Create, True, new String'("- Given the new file `config.ini` followed by code fenced content")));
   Set (Given, No_SA,  Subject_File, No_Verb,    No_Object, (Create_If_None, True, new String'("- Given the file `config.ini` followed by code fenced content")));
   ...
   Set (Then_P, No_SA, Output_Subj,  Is_V,     Obj_File_Name, (Output_Is, False, new String'("- Then output is file `expected.txt`")));
   Set (Then_P, No_SA, Output_Subj,  Is_V,     No_Object,     (Output_Is, True,  new String'("- Then output is followed by code fenced content")));
   ...
   Set (Then_P, No_SA, No_Subject,   Get,      No_Object,     (Output_Is, True,  new String'("- Then I get followed by code fenced content")));
   Set (Then_P, No_SA, Output_Subj,  Contains, Obj_Text,      (Output_Contains, False, new String'("- Then output contains `msg`")));
   Set (Then_P, No_SA, Output_Subj,  Contains, Obj_File_Name, (Output_Contains, False, new String'("- Then output contains `snippet.txt` file")));
   Set (Then_P, No_SA, Output_Subj,  Contains, No_Object,     (Output_Contains, True,  new String'("- Then output contains followed by code fenced content")));
   Set (Then_P, No_SA, Output_Subj,  Does_Not_Contain, Obj_Text,      (Output_Does_Not_Contain, False, new String'("- Then output does not contain `msg`")));
   Set (Then_P, No_SA, Output_Subj,  Does_Not_Contain, Obj_File_Name, (Output_Does_Not_Contain, False, new String'("- Then output does not contain file `snippet.txt`")));
   Set (Then_P, No_SA, Output_Subj,  Does_Not_Contain, No_Object,     (Output_Does_Not_Contain, True,  new String'("- Then output does not contain followed by code fenced content")));
   Set (Then_P, No_SA, Output_Subj,  Matches,         Obj_Text, (Output_Matches,        False, new String'("- Then output matches `[:digit:]*.[:digit:]*`")));
   Set (Then_P, No_SA, Output_Subj,  Does_Not_Match,  Obj_Text, (Output_Does_Not_Match, False, new String'("- Then output does not match `[:digit:]*.[:digit:]*`")));
   Set (Then_P, No_SA, Subject_File, Matches,         Obj_Text, (File_Matches,          False, new String'("- Then file `list` matches `*.string.*`")));
   Set (Then_P, No_SA, Subject_File, Does_Not_Match,  Obj_Text, (File_Does_Not_Match, False, new String'("- Then file `list` does not match `*.string.*`")));
   Set (Then_P, No_SA, Subject_File, Is_V,     Obj_Text,      (File_Is, False, new String'("- Then file `list` is `mode=silent`")));
   Set (Then_P, No_SA, Subject_File, Is_V,     Obj_File_Name, (File_Is, False, new String'("- Then file `list` is equal to file `expected/list`")));
   Set (Then_P, No_SA, Subject_File, Is_V,     No_Object,     (File_Is, True,  new String'("- Then file `list` is followed by code fenced content")));
   Set (Then_P, No_SA, Subject_File, Is_No,    Obj_File_Name, (File_Is_Not, False, new String'("- Then file `list` is no more equal to file `previous_list`")));
   Set (Then_P, No_SA, Subject_File, Contains, Obj_Text,      (File_Contains, False, new String'("- Then file `list` contains `--version`")));
   Set (Then_P, No_SA, Subject_File, Contains, Obj_File_Name, (File_Contains, False, new String'("- Then file `list` contains `snippet.txt` file")));
   Set (Then_P, No_SA, Subject_File, Contains, No_Object,     (File_Contains, True,  new String'("- Then file `list` contains followed by code fenced content")));
   Set (Then_P, No_SA, Subject_File, Does_Not_Contain, Obj_Text,      (File_Does_Not_Contain, False, new String'("- Then file `list` does not contain `--version`")));
   Set (Then_P, No_SA, Subject_File, Does_Not_Contain, Obj_File_Name, (File_Does_Not_Contain, False, new String'("- Then file `list` does not contain `snippet.txt` file")));
   Set (Then_P, No_SA, Subject_File, Does_Not_Contain, No_Object,     (File_Does_Not_Contain, True, new String'("- Then file `list` does not contain followed by code fenced content")));
