...
begin
   if Ada.Directories.Exists (File_Name) then
      ...
      Put_Line ("  If what you want is just test that the output contains something, then use:  ");
      ...
      New_Line;
      Put_Line ("To get a complete (although less friendly) view on the grammar : bbt -lg  ");
      Put_Line ("And the to get the list of keywords : bbt -lk  ");
      New_Line;
      Put_Line ("More features here : https://github.com/LionelDraghi/bbt/tree/main");
