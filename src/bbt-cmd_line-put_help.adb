...
begin
   case Topic is
      ...
      when Tutorial =>
         ...
         Put_Line ("");
         Put_Line ("This is a bbt tutorial, generated with BBT 0.3.0-dev  ");
         Put_Line ("");
         Put_Line ("A bbt file contains:");
         Put_Line ("1. text that is ignored");
         Put_Line ("2. scenarios that are interpreted");
         Put_Line ("");
         Put_Line ("A Scenario minimal structure is:");
         Put_Line ("1. a Scenario header, that is a line starting with '# Scenario'");
         Put_Line ("2. One or more Steps, that is lines starting with `- Given`, `- When` or `- Then`");
         Put_Line ("");
         Put_Line ("**Example** :  ");
         Put_Line ("");
