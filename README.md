...
bbt aims at being to easy and obvious way to run 90% of the boring usual tests ``when I have PATH=.. and config.ini contains lang=fr and there is a directory dir1 and I run `make_my_day --all_the_way` then ``  etc., targetting command line programs.
