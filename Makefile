...
doc: ./bbt
	...
	echo '---------|-----'          >> fixme_index.md
	grep -rn 'Fixme:' docs/* src/* | sort --ignore-case | sed -E "s/:/|/2;s/Fixme://;s/(^[^:]*)/[\1](\.\.\/\1)/" >> fixme_index.md
	...
	echo '---------|-----'             			    >> issues_index.md
	grep -rn 'Issue #' docs/* src/* | sort --ignore-case |  sed -E "s/:/|/2;s/Issue #/#/;s/(^[^:]*)/[\1](\.\.\/\1)/" >> issues_index.md
