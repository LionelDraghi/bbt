...
*** NOK : Then I get an error (..\docs\features\a190_run.md:46:)  
..\docs\features\a190_run.md:46: Error : Expected error code, got no error  
*** NOK : And  the output contains `cmd_not_exe.md:2: Error : ./lambda_file not executable` (..\docs\features\a190_run.md:47:)  
..\docs\features\a190_run.md:47: Error : Output:  
~~~
...
..\docs\features\b040_find_scenarios.md:64: Error : Output:  
~~~
dir1\scen1.md  
dir1\scen2.md
~~~
...
..\docs\features\b040_find_scenarios.md:93: Error : Output:  
~~~
dir1\dir2\scen5.md  
...
*** NOK : then I get no error (..\docs\features\b110_spawn.md:11:)  
..\docs\features\b110_spawn.md:11: Error : No error expected, but got one ( 1)  
*** NOK : And there is a file `dir 1/file 1` (..\docs\features\b110_spawn.md:12:)  
..\docs\features\b110_spawn.md:12: Error : Expected file "dir 1/file 1" doesn't exists  
