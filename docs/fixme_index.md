...
[src/bbt-scenarios-files.adb](../src/bbt-scenarios-files.adb):199|            --  to be moved in Text_Utilities or so
[src/bbt-scenarios-files.adb](../src/bbt-scenarios-files.adb):49|         --  need a test
[src/bbt-scenarios-steps.adb](../src/bbt-scenarios-steps.adb):251|      -- To move in Text_Utilities
[src/bbt-scenarios-steps.adb](../src/bbt-scenarios-steps.adb):291|               when Unknown    => null; --  should be an explicit error message?
